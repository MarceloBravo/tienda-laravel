...
class PermisosController extends Controller
{
    ...
    public function edit($idRol)
    {
        ...
        $permisos = DB::table(DB::raw("({$subQry->toSql()}) as qry"))
                            ...
                            ->orWhere('pantallas.permite_crear','=',1)
            ...
            foreach($request->all() as $key => $value)
            {
                ...
                if($id != "_method" && $id != "_token" && $id != "_rol")
                {
                    ...
                    if($id.$idPantalla != $idAnterior)
                    {
                        ...
                        $acceder = isset($request[$id.'-'.$idPantalla.'-acceder']) ? $request[$id.'-'.$idPantalla.'-acceder'] : 0 ;
                        ...
                        $this->grabar($id, $idPantalla, $request->_rol, $acceder, $crear, $actualizar, $eliminar);
                    }
                }
            }
            DB::commit();
    ...
    private function grabar($id, $pantalla_id, $rol_id, $acceder, $crear, $actualizar, $eliminar)
    {
