...
class ShoppingController extends Controller
{
    ...
    public function Home()
    {
        ...
        $masVendidos = OrdenItem::OrderBy('updated_at','desc')->limit(5)->get();
        ...
        $masVendidos2 = OrdenItem::join('productos','ordenes_items.producto_id','=','productos.id')
                                ...
                                ->select(DB::raw('@row := @row + 1 as fila'),'productos.id','productos.nombre','productos.precio','productos.precio_anterior', 'imagenes_productos.url','categorias.nombre as categoria',DB::raw('count(productos.id) as cant'))                                
                                ->limit(6)
        ...
        return view('welcome', compact('destacados','nuevos','masVendidos','masVendidos2','masVendidos3','masVendidos4'));
    }
