            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        {!! Form::model($comuna, ['id' => 'form', 'route'=>['comunas.update', $comuna->id], 'method'=>'PUT']) !!}

                            @include('admin.comunas.fields-form')
                            
                        {!! Form::close() !!}

                        <form id="eliminar" method="post" action="/admin/comunas/{{ $comuna->id}}">
                        ...
                        <div class="row">
                            <div class="form-group buttons-group">
                                ...
                                <a href="/admin/comunas" class="btn btn-default">Cancelar</a>
                            </div>
                        </div>
                    </div>
                </section>
...
<script src="{{ asset('js/mantenedores/comunas.js') }}"></script>
@endsection