...
<section class="panel">
    ...
    <div class="panel-body">
        <div class="row form-group">
            <div class="col-md-6">
                <a href="/admin/comunas/create" class="btn btn-primary">Nuevo</a>
            </div>
            <div class="col-md-6">
                <form id="form-filtro" action="/admin/comunas-filtro" method="POST">                        
                    @csrf
        ...
        <table class="table table-bordered table-striped mb-none" id="datatable-default">
            ...
            @foreach($comunas as $item)                        
                <tr>
                    <td>{{ $item->nombre }}</td>
                    <td>{{ $item->region()->get()[0]->nombre }}</td>
                    <td>{{ $item->region()->get()[0]->pais()->get()[0]->nombre }}</td>
                    <td class="col-editar">
                        <a href="/admin/comunas/{{ $item->id }}/edit"><i class="fa fa-pencil"></i></a>
                    </td>
                </tr>
            @endforeach
            </tbody>
