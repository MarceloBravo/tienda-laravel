        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <div class="row form-group">
                    <div class="col-md-6">
                        <a href="/admin/estados/create" class="btn btn-primary">Nuevo</a>
                    </div>
                    <div class="col-md-6">
                        <form id="form-filtro" action="/admin/estados-filtro" method="POST">                        
                            @csrf
                ...
                <table class="table table-bordered table-striped mb-none" id="datatable-default">
                    ...
                    @foreach($estados as $item)                        
                        <tr>
                            <td>{{ $item->nombre }}</td>
                            <td class="col-editar">
                                <a href="/admin/estados/{{ $item->id }}/edit"><i class="fa fa-pencil"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
