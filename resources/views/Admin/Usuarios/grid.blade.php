...
<section class="panel">
    ...
    <div class="panel-body">
        <div class="row form-group">
            <div class="col-md-6">
                <a href="/admin/usuarios/create" class="btn btn-primary">Nuevo</a>
            </div>
            <div class="col-md-6">
                <form id="form-filtro" action="/admin/usuarios-filtro" method="POST">                        
                    @csrf
        ...
        <table class="table table-bordered table-striped mb-none" id="datatable-default">
            ...
            @foreach($usuarios as $item)
                <tr>
                    ...
                    <td class="col-editar">
                        <a href="/admin/usuarios/{{ $item->id }}/edit"><i class="fa fa-pencil"></i></a>
                    </td>
                </tr>
            @endforeach
            </tbody>
